...
public class Aplicacion 
{
	...
	{	//Variables.
		...
		Pronostico pronosticoPartido2 = new Pronostico(Integer.parseInt(datosExtraidosA2L2.get(0)), Integer.parseInt(datosExtraidosA2L2.get(4)), datosExtraidosA2L2.get(1), datosExtraidosA2L2.get(3), datosExtraidosA2L2.get(2), partido2, resultadoPartido2);
		//Creamos la ronda 1
